    ...
    >
      <div className="flex items-center justify-between gap-12">
        <div className="flex flex-col">
          ...
          <a
            href="#kursy"
            className="bg-primaryBlue font-semibold cursor-pointer transition-all duration-300 hover:-translate-y-1 shadow-lg hover:shadow-xl hover:bg-secondaryBlue dark:bg-primaryGreen dark:hover:bg-secondaryGreen w-[75%] py-3 text-white rounded-md dark:text-blackText text-center"
          >
            Zobacz kursy
          </a>
        </div>
