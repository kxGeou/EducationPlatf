...
export default function ExamSettings() {
  ...
  return (
    <div className="bg-white dark:bg-DarkblackBorder rounded-lg shadow-xl p-6 md:p-8 border border-gray-100 dark:border-DarkblackText">
      {/* Progress Indicator */}
      <div className="mb-8">
      ...
      <div className="relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {courses.map((c) => (
                <button
                  key={c.id}
                  type="button"
                  className={`relative rounded-lg transition-all duration-200 border-2 overflow-hidden text-left ${
                    course === c.id 
                ...
                >
                  ...
                  {c.image_url ? (
                    <div className="relative w-full h-64 overflow-hidden bg-gray-200 dark:bg-DarkblackText">
                      <img
                        src={c.image_url}
                        alt={c.title}
                    ...
                    <div className={`w-full h-64 p-4 flex items-end font-semibold text-sm ${
                      course === c.id 
                        ? "bg-primaryBlue dark:bg-primaryGreen text-white" 
        ...
        >
          ...
          {selectedCourse && (
            <div className="mb-6 p-4 bg-gray-50 dark:bg-DarkblackText rounded-lg border border-gray-200 dark:border-DarkblackText">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="ml-4 px-3 py-1 text-xs text-primaryBlue dark:text-primaryGreen hover:underline"
                >
                  Zmień
                </button>
              </div>
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-3 gap-4">
              {[10, 20, 40].map((n) => (
                <button
                  key={n}
                  className={`px-4 py-4 rounded-lg transition-all duration-200 font-semibold text-lg ${
                    numQ === n 
          ...
          <div className="space-y-3">
            <button
              className="w-full px-4 py-3 bg-gradient-to-r from-primaryBlue to-secondaryBlue dark:from-primaryGreen dark:to-secondaryGreen text-white font-semibold text-base rounded-md  duration-300 transition-all cursor-pointer"
            ...
            <button
              className="w-full px-4 py-3 bg-gradient-to-r from-primaryGreen to-secondaryGreen text-white font-semibold text-base rounded-md  duration-300 transition-all cursor-pointer"
            ...
            <button
              className="w-full px-4 py-3 bg-gray-100 dark:bg-DarkblackText text-gray-700 dark:text-gray-300 font-semibold text-base rounded-md hover:bg-gray-200 dark:hover:bg-DarkblackText/80 duration-300 transition-all cursor-pointer flex items-center justify-center gap-2"
              onClick={handleBackStep}
            >
