...
import { Clock, Users, User, Edit, Trash2, CheckCircle, XCircle, Eye } from 'lucide-react';

export default function UpcomingTermsSection({ timeAgo }) {
  const {
    availability,
    bookings,
    loading,
  ...
  return (
    <>
      ...
      {/* Bookings Modal - można dodać później jeśli potrzebne */}
    </>
  );
}
