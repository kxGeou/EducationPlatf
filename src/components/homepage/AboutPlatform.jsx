...
Dostosujemy zajęcia do Twojego poziomu i celu - matura, egzamin zawodowy, poprawka lub bieżące zaległości.
        ...
        <button className="mt-6 w-full bg-gradient-to-r to-primaryBlue  from-darkBlue dark:from-primaryGreen dark:to-secondaryGreen text-white py-2 md:py-3 rounded-[12px] cursor-pointer">
