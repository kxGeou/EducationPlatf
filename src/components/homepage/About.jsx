  ...
  return (
    ...
    >
      <div className="lg:flex md:flex-col md:w-[400px]">
        <SectionHeading textColor={"text-secondaryBlue dark:text-secondaryGreen"}>O nas</SectionHeading>
        <div className='flex flex-col gap-2'>
          <Heading2 margin={"mb-2"} textColor={"text-blackText dark:text-white"}>
