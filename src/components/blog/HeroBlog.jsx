    ...
    <section className='w-full flex justify-between items-center mb-36 px-6'>
        <div>
          ...
          <div className='flex flex-col items-start text-5xl md:text-7xl'>
            ...
            <button className='flex items-center gap-1 text-white mt-6 md:text-lg cursor-pointer  rounded-[12px] px-4 py-[6px] bg-secondaryBlue'>Zobacz blogi <ChevronRight size={20}></ChevronRight></button>
        </div>
