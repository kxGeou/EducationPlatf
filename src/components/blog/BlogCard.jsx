  ...
  return (
    <div className='min-w-[300px] max-w-[320px] rounded-xl shadow-lg bg-white dark:bg-DarkblackBorder overflow-hidden flex flex-col'>
      ...
      <div className='p-4 flex flex-col justify-between flex-grow'>
        ...
        <p className='text-sm text-gray-600 mt-2 dark:text-white/75 line-clamp-3'>
          {description}
        </p>
        <Link 
          to={`/blog/${id}`} 
          className='flex items-center text-secondaryBlue dark:text-primaryGreen cursor-pointer font-semibold mt-4 text-sm hover:underline'
        >
