    ...
    <header className="relative flex justify-between w-full item-scenter py-6 px-6 z-100">
      ...
      {visibleModal ?
       <div className="flex flex-col gap-3 text-white text-lg mt-3">
          <p className="transition-all hover:text-blue-600 cursor-pointer">O nas</p>
          <p className="transition-all hover:text-blue-600 cursor-pointer">Osiągnięcia</p>
          <p className="transition-all hover:text-blue-600 cursor-pointer">Kursy</p>
          <p className="transition-all hover:text-blue-600 cursor-pointer">Opinie</p>
      </div> : null}
      ...
      : 
        <div className="w-full flex justify-between items-center">
          <ul className="flex gap-6 text-white font-semibold w-full items-center">
            <li className="transition-all hover:text-white/75 cursor-pointer">O nas</li>
            <li className="transition-all hover:text-white/75 cursor-pointer">Osiągnięcia</li>
            <li className="transition-all hover:text-white/75 cursor-pointer">Kursy</li>
