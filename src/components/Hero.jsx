    ...
    <div className="flex flex-col gap-5 z-10 w-full px-6 mt-8">
      <div className="flex items-center justify-between gap-20">
        <div className="flex flex-col gap-6 lg:gap-10">
          <h2 className={`font-bold text-4xl leading-[40px] text-darkerBlack md:text-7xl md:leading-[80px] w-full max-w-[400px] md:max-w-[750px] lg:max-w-[650px] lg:font-extrabold`}>
            Lorem ipsum dolor sit amet consectetur adipisicing iwir
          </h2>

          <p className="opacity-85 text text-gray-700 w-full max-w-[450px] lg: md:max-w-[430px] text-lg">
